...
@section('content')
    ...
    <div class="content-slider">
      ...
      <div class="slider">
        <div id="top-banner-1" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              <h2>Buat kalian yang sedang merajut impian di</h2>
              <h1>Universitas Airlangga (UNAIR)</h1>
        ...
        <div id="top-banner-2" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              <h2>Buat kalian juga yang lagi berjuang di</h2>
              <h1>Institut Teknologi Sepuluh November (ITS)</h1>
              <div class="border-button"><a href="/about">Go There</a></div>
            </div>
            <div class="container">
              <div class="row">
        ...
        <div id="top-banner-3" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              <h2>Buat yang ingin merajut kenangan di</h2>
              <h1>Universitas Surabaya (UBAYA)</h1>
              <div class="border-button"><a href="/about">Go There</a></div>
            </div>
            <div class="container">
              <div class="row">
        ...
        <div id="top-banner-4" class="banner">
          <div class="banner-inner-wrapper header-text">
            <div class="main-caption">
              <h2>Juga Buat kalian yang menimba ilmu di</h2>
              <h1>Universitas Katolik Widya Mandala Surabaya (UKWMS)</h1>
              <div class="border-button"><a href="/about">Go There</a></div>
            </div>
            <div class="container">
              <div class="row">
                ...
                <div class="item">
                  <div class="row">
                    <div class="col-lg-4 col-sm-5">
                      <div class="image">
                        <img src="{{ asset('images/country-01.jpg')}}" alt="">
                      </div>
                    </div>
              ...
              <div class="col-lg-12">
                <div class="item">
                  <div class="row">
                    <div class="col-lg-4 col-sm-5">
                      <div class="image">
                        <img src="{{ asset('images/country-02.jpg')}}" alt="">
                      </div>
                    </div>
                    <div class="col-lg-8 col-sm-7">
                      <div class="right-content">
              ...
              <div class="col-lg-12">
                <div class="item last-item">
                  <div class="row">
                    <div class="col-lg-4 col-sm-5">
                      <div class="image">
                        <img src="{{ asset('images/country-03.jpg')}}" alt="">
                      </div>
                    </div>
                    <div class="col-lg-8 col-sm-7">
                      <div class="right-content">
  ...
  <div class="call-to-action">
    <div class="container">
      <div class="row">
        <div class="col-lg-8">
          <h2>Kamu Cari Tour Guide di Kampus Impianmu?</h2>
          <h4>Buat Reservasi Dengan Klik Tombol Berikut</h4>
        </div>
        <div class="col-lg-4">
          <div class="border-button">
            <a href="reservation.html">Booking Tanggal</a>
          </div>
        </div>
      </div>
    </div>
